...
import { EnhancedHeader, EnhancedNav, EnhancedFooter, Section } from '@/components/EnhancedLayout';
...
export default function AnalyticsDashboard() {
  ...
  return (
    <>
      ...
      {/* Key Metrics */}
      <Section title={t('المقاييس الرئيسية', 'Key Metrics')} variant="light">
      ...
      {/* Charts Section */}
      <Section title={t('التوزيع والاتجاهات', 'Distribution & Trends')} variant="dark">
      ...
      {/* Top Content */}
      <Section title={t('المحتوى الأعلى أداءً', 'Top Performing Content')} variant="light">
      ...
      {/* Export Section */}
      <Section title={t('تصدير البيانات', 'Export Data')} variant="dark">
